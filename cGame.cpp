...
void cGame::initialise(SDL_Window* theSDLWND, SDL_Renderer* theRenderer)
{
	...
	texturesToUse = { "Images\\Enemy(1).png", "Images\\Enemy(2).png", "Images\\Enemy(3).png", "Images\\Enemy(4).png", "Images\\bullet.png", "Images\\Player(1).png", "Images\\Background.png" };
	...
	gameTextList = { "Crossfire"};
	
	theTextureMgr->addTexture("Title", theFontMgr->getFont("Airstrike")->createTextTexture(theRenderer, gameTextList[0], SOLID, { 255, 231, 78, 255 }, { 0, 0, 0, 0 }));
